export const firebaseErrorsTranslation: { [key: string]: string } = {
  "auth/app-deleted": "O banco de dados não foi localizado.",
  "auth/invalid-login": "E-mail ou senha incorretos.",
  ...
  "auth/invalid-credential": "Email e/ou senha incorretos.",
